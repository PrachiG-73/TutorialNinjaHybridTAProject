...
public class Utilities {
	...
	public static String generateTimeStamp() {
		...
		String finalEmailAddress = "pg20000703" + timeStamp + "@gmail.com";
	...
	public static Object[][] getTestDataFromExcel(String sheetName) {
		...
		File excelFile = new File(System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\tutorialninjaproj\\qa\\testdata\\TutorialsNinja.xlsx");
	...
	public static String getScrrenshotDestination(WebDriver driver,String testName) {
